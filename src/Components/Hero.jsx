  ...
  return (
    ...
    >
      <div className="w-full max-w-8xl h-full pb-5 mx-auto">
        {/* Header Section */}
        <div
          className="lg:pt-[2vh] px-4 sm:px-8 md:px-12 lg:px-[70px]"
          data-aos="fade-up"
        >
          ...
          {/* Main Heading */}
          <h1
            className="pt-5 font-medium text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight"
            data-aos="fade-up"
            data-aos-delay="150"
          >
            Crafting{" "}
        ...
        {/* Description Section */}
        <div
          className="flex flex-col sm:flex-row items-start sm:items-center mt-6 sm:mt-8"
          data-aos="fade-up"
          data-aos-delay="300"
        >
        ...
        {/* Buttons Section */}
        <div
          className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-4 sm:px-8 md:px-12 lg:px-[70px] gap-6 sm:gap-0"
          data-aos="fade-up"
          data-aos-delay="450"
        >
          {/* Social Links */}
